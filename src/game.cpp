...
void playgame()
{
    ...
    while (true)
    {
        ...
        if (option==1)
        {
            ...
            Weapon* barista_weapon=new Weapon("Coffee Cup (+10 DMG)", 10);
            barista->setloot(barista_weapon);
            ...
            cout<<"\n";
            writetext("Suddenly, you see the gym trainer approaching you, menacingly. He's shouting something while pointing at you, but you can't quite make sense of it because of the loud music. Your vision begins to blur and panic begins to take over you.");
            cout<<"\n";

            //trainer fight
            Enemy* trainer=factory.create_enemy("Trainer");
            Consumable* trainer_item=new Consumable("Protein Shake (+15 HP)",15);
            trainer->setloot(trainer_item);
            win=Fight::getinstance().battle(player, *trainer);
            while (!win)
            {
                while (true)
                {
            ...
            delete trainer;
            writetext("You take a deep breath and see the trainer standing in front of you, but not with any bad intentions, only with genuine concern.");
            cout<<"\n";
            writetext("[Trainer]: \"Hey, take it easy! I saw you lifting from across the gym. You're going to seriously injure yourself with that form. Here, let me show you...");
            cout<<"\n";
            ...
            cout<<"\n";
            writetext("[Trainer]: \"You look a bit exhausted and pale. Here, take this... It'll give you a boost of energy. Have a good workout!\"");
            cout<<"\n";
            ...
            Consumable* manager_item=new Consumable("Bag of Snacks (+25 HP)", 25);
            manager->setloot(manager_item);
